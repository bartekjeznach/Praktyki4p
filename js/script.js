...
const getMovie = async (id) => {
    ...
    "</h6> </div> <div class='ext3'><b>Genre:</b> <br>" + data.genres[0].name+ ", "+data.genres[1].name +", "+data.genres[2].name +"<br><b>Release date:</b> <br>"+data.release_date+ "<br><b>Runtime: </b><br>"+
    data.runtime+"min"+ "<br> <b>Director:</b> <div id='director'></div>"+
